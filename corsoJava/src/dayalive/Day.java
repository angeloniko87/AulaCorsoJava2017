...
//importiamo la classe del calendario gregoriano
import java.util.GregorianCalendar;


public class Day
{
	//dichiariamo le variabili interi anno, mese e data
   private int year;
   private int month;
   private int date;
   ...
   /**
      metodo costruttore per inserira la data 
   */
   public Day()
   {
      GregorianCalendar today = new GregorianCalendar(); //con "()" carica la data corrente 
      year = today.get(GregorianCalendar.YEAR);
      month = today.get(GregorianCalendar.MONTH) + 1; //i mesi partono da 0 per questo si aggiunge +1
